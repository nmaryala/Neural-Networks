...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        #weights and biases for the hidden affine layer
        self.params['W2'] = weight_scale * np.random.randn(num_filters * H_prime * W_prime, hidden_dim)
        self.params['b2'] = np.zeros(hidden_dim)

        #weights and biases for output affine layer
    ...
    def loss(self, X, y=None):
        ...
        out_aff1, cache2 = affine_relu_forward(out_pool, W2, b2)
        scores, cache3 = affine_forward(out_aff1, W3, b3)
        ...
        out3, grads['W3'], grads['b3']  = affine_backward(grad, cache3)
        out2, grads['W2'], grads['b2']  = affine_relu_backward(out3, cache2)
        out1, grads['W1'], grads['b1']  = conv_relu_pool_backward(out2, cache1)
